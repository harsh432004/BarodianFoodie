...
export const FOODFIRE_API_URL = `${process.env.REACT_FOODFIRE_APP_BASE_URL}restaurants?lat=22.30080&lng=73.20430&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING`;
...
// Github - username
export const Github_UserName = "Harsh";
...
export const Twitter_Link = "https://";
export const Github_Link = "https";
